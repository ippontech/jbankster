...
export class UserProfileResolve implements Resolve<IUserProfile> {
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot) {
        ...
        if (id) {
            return this.service.find(id).map((userProfile: HttpResponse<UserProfile>) => userProfile.body);
        }
        return Observable.of(new UserProfile());
    }
}
...
export const userProfileRoute: Routes = [
    {
        ...
        data: {
            ...
            pageTitle: 'jBanksterApp.userProfile.home.title'
        },
