...
export interface IUserProfileDeleteDialogProps extends StateProps, DispatchProps, RouteComponentProps<{ id: number }> {}
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody>
          <Translate contentKey="jbanksterApp.userProfile.delete.question" interpolate={{ id: userProfileEntity.id }}>
